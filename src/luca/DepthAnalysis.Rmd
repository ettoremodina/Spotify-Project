...
ii = 1
jj = 3
music_cov = colnames(data_numeric_cleaned)[ii]
survey_cov = colnames(questionario)[jj]
...
for (i in 1:num_groups) {
  ...
  legend("topright", legend = unique_groups, col = color_palette, lwd = 2)
}
```
...
```{r,warning=FALSE}
for(m in music_vars){
  depth_covcov(m,"Quanti.libri.hai.letto.nell.ultimo.mese.")
}
```
