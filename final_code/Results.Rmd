...
```{r}
list_intervals = readRDS("data_final/conformal_intervals_byGroups_medians.RData")
...
ind3<-paste0( "age",": ","Over23",", VAR: ","acousticness") #person1
ind4<-paste0( "age",": ","Under23",", VAR: ","acousticness") #person2
...
ind9<-paste0( "age",": ","Over23",", VAR: ","energy") #person1
ind10<-paste0( "age",": ","Under23",", VAR: ","energy") #person2
...
inst_abroadNO<-list(c(0.000,0.000))
...
ind19<-paste0( "age",": ","Over23",", VAR: ","loudness") #person1
ind20<-paste0( "age",": ","Under23",", VAR: ","loudness") #person2
...
selected_songs1 <- songs1[
 ...
 songs1$instrumentalness>= unlist(inst_abroadNO)[1] &songs1$instrumentalness<=unlist(inst_abroadNO)[2] &
