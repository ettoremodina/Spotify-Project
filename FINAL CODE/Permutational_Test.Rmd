...
## 2 sample Permutational test using geometric sample to provide independence of the observations 
...
## 2 sample Permutational test using median of the playlist descriptors to provide independence of the observations 
...
```{r}
saveRDS(res,"data_final/pvalues_cat.RData")
saveRDS(reduced,"data_final/survey_reduced.RData")
...
res<-readRDS("data_final/pvalues_cat.RData")
```
